...
import com.example.projectole.PesanSkrgActivity
...
class DetailMakananFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_detail_makanan, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        pesanButton = view.findViewById(R.id.pesanButton)
...
//        }
        ...
        pesanButton.setOnClickListener(View.OnClickListener {
            val pesan = Intent(requireContext(), PesanSkrgActivity::class.java)
            startActivity(pesan)
        })
